<?php  //[STAMP] 96f763a957fe33729ba030fe4da7ec7e
namespace hipanel\modules\stock\tests\_support\_generated;
...
trait AcceptanceTesterActions
{
     ...
     */
    public function pressButton($textOnButton, $xpathPrefix = null) {
     ...
     * @throws \Codeception\Exception\ModuleException
     * @return int
     * @see \hipanel\tests\_support\Helper\CountHelper::countElements()
     */
    public function countElements($cssOrXpath) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('countElements', func_get_args()));
    }
     ...
     * @return int
     * @throws \Codeception\Exception\ModuleException
     * @see \hipanel\tests\_support\Helper\CountHelper::indexOf()
     */
    public function indexOf($elementSelector, $setSelector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('indexOf', func_get_args()));
    }
}
